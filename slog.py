...
class Slog(object):
    def __init__(self, logfile=None, loglvl=3, inspect=False, bufsize=4096, splotch=u'o'):
        # the log file
...
log = Slog(logfile="test.log", loglvl=5, inspect=True)
for lvl in range(10000000): getattr(log, 'ok')('Hello, World!')
